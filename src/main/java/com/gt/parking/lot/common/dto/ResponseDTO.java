package com.gt.parking.lot.common.dto;
...
public class ResponseDTO<T> implements Serializable {
     ...
     * @return ResponseDTO
     */
    public static < T > ResponseDTO< T > createBySignErrorMessage( String errorMessage ) {
        return createByErrorCodeMessage( ResponseEnums.SIGN_ERROR.getCode(), errorMessage );
    }
