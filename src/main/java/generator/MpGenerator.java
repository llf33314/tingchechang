...
public class MpGenerator {
    ...
    // 项目的绝对路径 —— 自己配置
    public static final  String   outPutBaseDir      = "E:/workspaceIDEA/GT/gt_log_general/gt_log_center/";
    // 生成*.java 的文件路径
    public static final  String   outPutJavaModel    = outPutBaseDir + "src/main/java";
    // 需要生成的表----------------------------------------------------------改这里
    public static final  String[] generatorTableName = new String[] {"t_project"};
    // 作者
    ...
    // url
    public static final  String   url                = "jdbc:mysql://113.106.202.51:3306/gt_dac?characterEncoding=utf8";
    // 数据库用户名
